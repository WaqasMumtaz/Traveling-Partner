...
const PoolRideDetail = () => {
    ...
    function closeModal() {
        ...
        if (ride.confirm == true) {
            navigation.navigate('DeliveryDriver');
        }
    }
                ...
                <View style={{ flex: 1 }}>
                        ...
                        <View style={{ flex: 1, marginLeft: 15 }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center', flex: 1 }}>
                                    ...
                                    <IonicIcon name='checkmark-circle' size={15} color={Global.green_clr} style={{ marginLeft: 10 }} />
                                </View>
                    ...
                    <View style={{ flex: 1, marginHorizontal: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-evenly', marginVertical: 20 }}>
                        <Components.Gradient _style={styles.btn}>
                            <TouchableOpacity
                                onPress={() => handleRide('sent')}
                                style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}
                            >
                                <Text style={{ fontWeight: 'bold' }}>Sent Request</Text>
                            </TouchableOpacity>
                        </Components.Gradient>
                        <TouchableOpacity
            ...
            >
                <View style={{ paddingBottom: 20 }}>
                    {ride.sent_req && (
                        <>
                            <View style={{alignItems:"center"}}>
                                <Components.Heading3 title={'Fare'} />
                            </View>
