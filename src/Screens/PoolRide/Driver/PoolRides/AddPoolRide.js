...
const AddPoolRide = () => {
    ...
    function handleOptions(name, value) {
            ...
            <SafeAreaView style={styles.container}>
                ...
                >
                    <View style={{ alignItems: 'center' }}>
                        <Components.Heading3 title={'Driver'} />
                    </View>
                    <View style={{ margin: 15 }}>
                        ...
                        {selectedValue === 'In-City' && (
                            <>
                                ...
                                />
                                {errorObj.seats ? (
                                    <Text style={styles.error}>{errorObj.seats}</Text>
                                ) : (
                                    null
                                )}
                                <View style={{ margin: 10 }} />
                                ...
                                <View style={{ flexDirection: 'row', alignItems: "center" }}>
                                    <TemplateComponents.Checkbox
                                        title={'Bags'}
                                        value={authObj.bags}
                                        onChange={(value) => handleOptions('bags', value)}
                                    />
                                    <TemplateComponents.Checkbox
                                        title={'Pets'}
                                        value={authObj.pets}
                                        onChange={(value) => handleOptions('pets', value)}
                                    />
                                    <TemplateComponents.Checkbox
                                        title={'Smoke'}
                                        value={authObj.smoke}
                                        onChange={(value) => handleOptions('smoke', value)}
                                    />
                                </View>
                            </>
                        )}
                    ...
                    <View style={{ margin: 15 }}>
                        ...
                        <Components.MainButton
                            title={'Sent'}
                            handleNavigation={() => navigation.navigate('Driver FoundRide')}
                        />
                        <View style={{ margin: 15 }} />
                        <Components.AdBanner />
                    </View>
